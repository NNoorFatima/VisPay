...
import { useState } from "react";
import { Routes, Route, Navigate } from "react-router-dom";
import PaymentVerification from "./components/PaymentVerfication"; // Keeps original filename with typo
import ProductSearch from "./components/ProductSearch";
import Navigation from "./components/Navigation";
import ResultsPanel from "./components/ResultsPanel";

// Wrapper for the Payment Verification View
function PaymentPage({ onResultChange, onProcessingChange }) {
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-base text-muted-foreground max-w-2xl">
          Verify payment receipts using OCR. Toggle between Standard and Digital verification modes.
        </p>
      </div>
      <div className="bg-card rounded-xl border border-border shadow-lg overflow-hidden">
        {/* The unified component now handles both modes */}
        <PaymentVerification
          onResultChange={onResultChange}
          onProcessingChange={onProcessingChange}
        />
...
// Wrapper for the Product Search View
function SearchPage({ onResultChange, onProcessingChange }) {
  return (
    <div className="p-8">
      <div className="mb-8">
